...
void test_full_tree(void) {
    ...
    int result[10];
    size_t index = 0;
    bt_in_order(&nodes[0], result, &index);
...
int main(void) {
    printf(COLOR_BOLD "Running bt_in_order tests:\n" COLOR_RESET);
    ...
    PRINT_TEST_SUMMARY("bt_in_order");
